...
public class Game extends MethodProvider {
	...
	public static final int[] WORLDS_GERMAN = {122, 139, 140, 146, 147};
	public static final int[] WORLDS_FRENCH = {128, 150};
	public static final int[] WORLDS_PORTUGUESE = {94, 101, 125, 126, 127, 133};
	public static final int[] WORLDS_MEMBER = {2, 6, 9, 12, 15, 18, 21, 22, 23, 24, 26, 27, 28, 31, 32, 36, 39,
	...
	public static final int[] WORLDS_FREE = {1, 3, 4, 5, 7, 8, 10, 11, 13, 14, 16, 17, 19, 20, 25, 29, 30, 33, 34,
			35, 37, 38, 41, 43, 47, 49, 50, 55, 57, 61, 62, 73, 74, 75, 80, 81, 87, 90, 93, 94, 101, 102, 105, 106, 108,
